// Package backend 装配 quickaskd 的全部协议方法：
...
import (
	...
	"quickask/internal/llm"
	"quickask/internal/protocol"
	"quickask/internal/server"
...
func (b *Backend) handleHello(ctx context.Context, rid int64, params json.RawMessage, emit server.Emit) (any, error) {
	return api.HelloResult{Proto: protocol.Version, Name: "quickaskd", Version: b.Version}, nil
}
